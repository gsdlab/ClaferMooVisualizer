...
{}
{ (((((some this.@r_c4_HAVE_CRYPTO) && (some this.@r_c10_HAVE_HASH)) && (no this.@r_c16_HAVE_QUEUE)) && (some this.@r_c22_HAVE_REPLICATION)) && (no this.@r_c28_HAVE_VERIFY)) && (no this.@r_c46_DIAGNOSTIC) }
