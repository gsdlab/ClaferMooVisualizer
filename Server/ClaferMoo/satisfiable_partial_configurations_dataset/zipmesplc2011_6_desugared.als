...
{}
{ (((((((some this.@r_c4_base) && (some (this.@r_c4_base).@r_c10_zipMe)) && (some (this.@r_c4_base).@r_c16_zipMecompress)) && (no this.@r_c22_zipMeCRC)) && (some this.@r_c28_zipMearchiveCheck)) && (some this.@r_c34_zipMeGZIP)) && (no this.@r_c40_zipMeadaptation)) && (no this.@r_c52_zipMeextract) }
