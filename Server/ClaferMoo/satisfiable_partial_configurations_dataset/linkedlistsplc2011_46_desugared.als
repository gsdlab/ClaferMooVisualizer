...
{}
{ (((((((((some this.@r_c4_AbstractElement) && (no (this.@r_c4_AbstractElement).@r_c11_ElementA)) && (some (this.@r_c4_AbstractElement).@r_c23_ElementC)) && (some this.@r_c29_AbstractIterator)) && (some (this.@r_c29_AbstractIterator).@r_c35_ForwardIterator)) && (some this.@r_c47_AbstractSort)) && (no (this.@r_c47_AbstractSort).@r_c53_BubbleSort)) && (some (this.@r_c83_Measurement).@r_c97_SyntheticPerformanceOrMemorySize)) && (no ((this.@r_c83_Measurement).@r_c97_SyntheticPerformanceOrMemorySize).@r_c109_MemorySize)) && (some this.@r_c115_Base) }
