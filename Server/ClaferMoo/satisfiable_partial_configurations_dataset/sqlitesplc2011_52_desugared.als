...
{}
{ (((((((((((((((((((((((((((((((((((((((((((((((((((((((some (this.@r_c4_OperatingSystemCharacteristics).@r_c10_SQLITE_4_BYTE_ALIGNED_MALLOC) && (no ((this.@r_c4_OperatingSystemCharacteristics).@r_c34_ChooseSQLITE_TEMP_STORE).@r_c52_SQLITE_TEMP_STORE_EQ_2)) && (some this.@r_c64_EnableFeatures)) && (no (this.@r_c64_EnableFeatures).@r_c70_SQLITE_ENABLE_ATOMIC_WRITE)) && (no (this.@r_c64_EnableFeatures).@r_c76_SQLITE_ENABLE_COLUMN_METADATA)) && (some (this.@r_c64_EnableFeatures).@r_c84_SQLITE_ENABLE_FTS3)) && (no (this.@r_c64_EnableFeatures).@r_c90_SQLITE_ENABLE_FTS3_PARENTHESIS)) && (some (this.@r_c64_EnableFeatures).@r_c102_ChooseMemSys)) && (some ((this.@r_c64_EnableFeatures).@r_c102_ChooseMemSys).@r_c108_SQLITE_ENABLE_MEMSYS3)) && (some (this.@r_c64_EnableFeatures).@r_c120_SQLITE_ENABLE_RTREE)) && (no (this.@r_c64_EnableFeatures).@r_c126_SQLITE_ENABLE_STAT2)) && (no (this.@r_c64_EnableFeatures).@r_c132_SQLITE_ENABLE_UPDATE_DELETE_LIMIT)) && (no (this.@r_c64_EnableFeatures).@r_c138_SQLITE_ENABLE_UNLOCK_NOTIFY)) && (some (this.@r_c64_EnableFeatures).@r_c150_YYTRACKMAXSTACKDEPTH)) && (no (this.@r_c174_OmitFeatures).@r_c180_SQLITE_OMIT_ALTERTABLE)) && (some (this.@r_c174_OmitFeatures).@r_c194_SQLITE_OMIT_ATTACH)) && (no (this.@r_c174_OmitFeatures).@r_c201_SQLITE_OMIT_AUTHORIZATION)) && (some (this.@r_c174_OmitFeatures).@r_c208_SQLITE_OMIT_AUTOINCREMENT)) && (no (this.@r_c174_OmitFeatures).@r_c215_SQLITE_OMIT_AUTOMATIC_INDEX)) && (no (this.@r_c174_OmitFeatures).@r_c222_SQLITE_OMIT_AUTOINIT)) && (no (this.@r_c174_OmitFeatures).@r_c228_SQLITE_OMIT_AUTOVACUUM)) && (some (this.@r_c174_OmitFeatures).@r_c235_SQLITE_OMIT_BETWEEN_OPTIMIZATION)) && (no (this.@r_c174_OmitFeatures).@r_c255_SQLITE_OMIT_BUILTIN_TEST)) && (no (this.@r_c174_OmitFeatures).@r_c269_SQLITE_OMIT_CHECK)) && (no (this.@r_c174_OmitFeatures).@r_c276_SQLITE_OMIT_COMPILEOPTION_DIAGS)) && (no (this.@r_c174_OmitFeatures).@r_c283_SQLITE_OMIT_COMPLETE)) && (some (this.@r_c174_OmitFeatures).@r_c290_SQLITE_OMIT_COMPOUND_SELECT)) && (some (this.@r_c174_OmitFeatures).@r_c297_SQLITE_OMIT_CONFLICT_CLAUSE)) && (some (this.@r_c174_OmitFeatures).@r_c303_SQLITE_OMIT_DATETIME_FUNCS)) && (some (this.@r_c174_OmitFeatures).@r_c310_SQLITE_OMIT_DECLTYPE)) && (no (this.@r_c174_OmitFeatures).@r_c319_SQLITE_OMIT_DEPRECATED)) && (no (this.@r_c174_OmitFeatures).@r_c333_SQLITE_OMIT_FLAG_PRAGMAS)) && (no (this.@r_c174_OmitFeatures).@r_c340_SQLITE_OMIT_FLOATING_POINT)) && (some (this.@r_c174_OmitFeatures).@r_c347_SQLITE_OMIT_FOREIGN_KEY)) && (some (this.@r_c174_OmitFeatures).@r_c354_SQLITE_OMIT_GET_TABLE)) && (some (this.@r_c174_OmitFeatures).@r_c361_SQLITE_OMIT_INCRBLOB)) && (some (this.@r_c174_OmitFeatures).@r_c368_SQLITE_OMIT_INTEGRITY_CHECK)) && (no (this.@r_c174_OmitFeatures).@r_c382_SQLITE_OMIT_LOAD_EXTENSION)) && (some (this.@r_c174_OmitFeatures).@r_c403_SQLITE_OMIT_MEMORYDB)) && (some (this.@r_c174_OmitFeatures).@r_c410_SQLITE_OMIT_OR_OPTIMIZATION)) && (some (this.@r_c174_OmitFeatures).@r_c431_SQLITE_OMIT_PROGRESS_CALLBACK)) && (some (this.@r_c174_OmitFeatures).@r_c438_SQLITE_OMIT_QUICKBALANCE)) && (no (this.@r_c174_OmitFeatures).@r_c445_SQLITE_OMIT_REINDEX)) && (some (this.@r_c174_OmitFeatures).@r_c452_SQLITE_OMIT_SCHEMA_PRAGMAS)) && (some (this.@r_c174_OmitFeatures).@r_c466_SQLITE_OMIT_SHARED_CACHE)) && (some (this.@r_c174_OmitFeatures).@r_c473_SQLITE_OMIT_SUBQUERY)) && (some (this.@r_c174_OmitFeatures).@r_c480_SQLITE_OMIT_TCL_VARIABLE)) && (no (this.@r_c174_OmitFeatures).@r_c486_SQLITE_OMIT_TEMPDB)) && (some (this.@r_c174_OmitFeatures).@r_c492_SQLITE_OMIT_TRACE)) && (some (this.@r_c174_OmitFeatures).@r_c499_SQLITE_OMIT_TRIGGER)) && (no (this.@r_c174_OmitFeatures).@r_c506_SQLITE_OMIT_TRUNCATE_OPTIMIZATION)) && (some (this.@r_c174_OmitFeatures).@r_c519_SQLITE_OMIT_VACUUM)) && (some (this.@r_c174_OmitFeatures).@r_c526_SQLITE_OMIT_VIEW)) && (no (this.@r_c174_OmitFeatures).@r_c533_SQLITE_OMIT_VIRTUALTABLE)) && (no (this.@r_c174_OmitFeatures).@r_c540_SQLITE_OMIT_WAL)) && (some this.@r_c554_SQLITE_DEBUG) }
