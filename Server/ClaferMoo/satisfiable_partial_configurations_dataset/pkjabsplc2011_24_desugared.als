...
{}
{ (((((some this.@r_c4_Base) && (some (this.@r_c10_ContactListSource).@r_c16_ServerRoster)) && (some this.@r_c22_XEP0085)) && (some (this.@r_c22_XEP0085).@r_c28_Composing)) && (no (this.@r_c22_XEP0085).@r_c34_SendComposing)) && (some this.@r_c46_Timestamps) }
