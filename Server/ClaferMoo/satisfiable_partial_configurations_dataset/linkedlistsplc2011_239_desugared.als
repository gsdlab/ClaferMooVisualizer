...
{}
{ ((((((((no (this.@r_c4_AbstractElement).@r_c11_ElementA) && (no (this.@r_c4_AbstractElement).@r_c17_ElementB)) && (no (this.@r_c29_AbstractIterator).@r_c41_BackwardIterator)) && (some this.@r_c47_AbstractSort)) && (some (this.@r_c47_AbstractSort).@r_c65_InsertionSort)) && (no (this.@r_c47_AbstractSort).@r_c71_QuickSort)) && (no (this.@r_c83_Measurement).@r_c97_SyntheticPerformanceOrMemorySize)) && (no ((this.@r_c83_Measurement).@r_c97_SyntheticPerformanceOrMemorySize).@r_c103_Performance)) && (no ((this.@r_c83_Measurement).@r_c97_SyntheticPerformanceOrMemorySize).@r_c109_MemorySize) }
