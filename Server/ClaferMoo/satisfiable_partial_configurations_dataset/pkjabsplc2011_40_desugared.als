...
{}
{ ((((((some this.@r_c4_Base) && (some this.@r_c10_ContactListSource)) && (no (this.@r_c22_XEP0085).@r_c28_Composing)) && (no (this.@r_c22_XEP0085).@r_c34_SendComposing)) && (some this.@r_c46_Timestamps)) && (no this.@r_c52_XEP0092)) && (no (this.@r_c52_XEP0092).@r_c58_SendVersion) }
