...
{}
{ ((((((some this.@r_c4_Base) && (some this.@r_c10_HostnameLookups)) && (some this.@r_c17_KeepAlive)) && (no this.@r_c23_EnableSendfile)) && (some this.@r_c29_FollowSymLinks)) && (some this.@r_c42_ExtendedStatus)) && (no this.@r_c57_Handle) }
