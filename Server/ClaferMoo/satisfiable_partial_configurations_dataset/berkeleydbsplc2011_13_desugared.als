...
{}
{ (((((no this.@r_c4_HAVE_CRYPTO) && (some this.@r_c10_HAVE_HASH)) && (some this.@r_c22_HAVE_REPLICATION)) && (no this.@r_c34_HAVE_SEQUENCE)) && (no this.@r_c40_HAVE_STATISTICS)) && (some this.@r_c52_SYNTETHIC_BASE_FEATURE) }
