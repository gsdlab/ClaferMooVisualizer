...
{}
{ (((((((some this.@r_c4_Base) && (no this.@r_c10_HostnameLookups)) && (no this.@r_c17_KeepAlive)) && (no this.@r_c23_EnableSendfile)) && (no this.@r_c29_FollowSymLinks)) && (no this.@r_c42_ExtendedStatus)) && (some this.@r_c49_InMemory)) && (no this.@r_c57_Handle) }
