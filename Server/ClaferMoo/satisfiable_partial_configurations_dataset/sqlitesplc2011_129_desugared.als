...
{}
{ ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((some (this.@r_c4_OperatingSystemCharacteristics).@r_c10_SQLITE_4_BYTE_ALIGNED_MALLOC) && (no (this.@r_c4_OperatingSystemCharacteristics).@r_c16_SQLITE_CASE_SENSITIVE_LIKE)) && (no (this.@r_c4_OperatingSystemCharacteristics).@r_c22_SQLITE_HAVE_ISNAN)) && (some (this.@r_c4_OperatingSystemCharacteristics).@r_c34_ChooseSQLITE_TEMP_STORE)) && (no ((this.@r_c4_OperatingSystemCharacteristics).@r_c34_ChooseSQLITE_TEMP_STORE).@r_c40_SQLITE_TEMP_STORE_EQ_0)) && (some ((this.@r_c4_OperatingSystemCharacteristics).@r_c34_ChooseSQLITE_TEMP_STORE).@r_c46_SQLITE_TEMP_STORE_EQ_1)) && (no ((this.@r_c4_OperatingSystemCharacteristics).@r_c34_ChooseSQLITE_TEMP_STORE).@r_c52_SQLITE_TEMP_STORE_EQ_2)) && (no ((this.@r_c4_OperatingSystemCharacteristics).@r_c34_ChooseSQLITE_TEMP_STORE).@r_c58_SQLITE_TEMP_STORE_EQ_3)) && (no (this.@r_c64_EnableFeatures).@r_c76_SQLITE_ENABLE_COLUMN_METADATA)) && (no (this.@r_c64_EnableFeatures).@r_c90_SQLITE_ENABLE_FTS3_PARENTHESIS)) && (no (this.@r_c64_EnableFeatures).@r_c96_SQLITE_ENABLE_MEMORY_MANAGEMENT)) && (some (this.@r_c64_EnableFeatures).@r_c102_ChooseMemSys)) && (some ((this.@r_c64_EnableFeatures).@r_c102_ChooseMemSys).@r_c108_SQLITE_ENABLE_MEMSYS3)) && (no ((this.@r_c64_EnableFeatures).@r_c102_ChooseMemSys).@r_c114_SQLITE_ENABLE_MEMSYS5)) && (some (this.@r_c64_EnableFeatures).@r_c120_SQLITE_ENABLE_RTREE)) && (no (this.@r_c64_EnableFeatures).@r_c126_SQLITE_ENABLE_STAT2)) && (some (this.@r_c64_EnableFeatures).@r_c132_SQLITE_ENABLE_UPDATE_DELETE_LIMIT)) && (some (this.@r_c64_EnableFeatures).@r_c138_SQLITE_ENABLE_UNLOCK_NOTIFY)) && (no (this.@r_c64_EnableFeatures).@r_c150_YYTRACKMAXSTACKDEPTH)) && (no (this.@r_c156_DisableFeatures).@r_c162_SQLITE_DISABLE_LFS)) && (some this.@r_c174_OmitFeatures)) && (some (this.@r_c174_OmitFeatures).@r_c180_SQLITE_OMIT_ALTERTABLE)) && (some (this.@r_c174_OmitFeatures).@r_c187_SQLITE_OMIT_ANALYZE)) && (no (this.@r_c174_OmitFeatures).@r_c201_SQLITE_OMIT_AUTHORIZATION)) && (some (this.@r_c174_OmitFeatures).@r_c235_SQLITE_OMIT_BETWEEN_OPTIMIZATION)) && (no (this.@r_c174_OmitFeatures).@r_c241_SQLITE_OMIT_BLOB_LITERAL)) && (no (this.@r_c174_OmitFeatures).@r_c248_SQLITE_OMIT_BTREECOUNT)) && (no (this.@r_c174_OmitFeatures).@r_c262_SQLITE_OMIT_CAST)) && (no (this.@r_c174_OmitFeatures).@r_c269_SQLITE_OMIT_CHECK)) && (some (this.@r_c174_OmitFeatures).@r_c276_SQLITE_OMIT_COMPILEOPTION_DIAGS)) && (some (this.@r_c174_OmitFeatures).@r_c290_SQLITE_OMIT_COMPOUND_SELECT)) && (some (this.@r_c174_OmitFeatures).@r_c297_SQLITE_OMIT_CONFLICT_CLAUSE)) && (some (this.@r_c174_OmitFeatures).@r_c303_SQLITE_OMIT_DATETIME_FUNCS)) && (some (this.@r_c174_OmitFeatures).@r_c310_SQLITE_OMIT_DECLTYPE)) && (no (this.@r_c174_OmitFeatures).@r_c319_SQLITE_OMIT_DEPRECATED)) && (no (this.@r_c174_OmitFeatures).@r_c326_SQLITE_OMIT_EXPLAIN)) && (some (this.@r_c174_OmitFeatures).@r_c333_SQLITE_OMIT_FLAG_PRAGMAS)) && (some (this.@r_c174_OmitFeatures).@r_c347_SQLITE_OMIT_FOREIGN_KEY)) && (some (this.@r_c174_OmitFeatures).@r_c361_SQLITE_OMIT_INCRBLOB)) && (no (this.@r_c174_OmitFeatures).@r_c368_SQLITE_OMIT_INTEGRITY_CHECK)) && (some (this.@r_c174_OmitFeatures).@r_c375_SQLITE_OMIT_LIKE_OPTIMIZATION)) && (some (this.@r_c174_OmitFeatures).@r_c382_SQLITE_OMIT_LOAD_EXTENSION)) && (no (this.@r_c174_OmitFeatures).@r_c389_SQLITE_OMIT_LOCALTIME)) && (some (this.@r_c174_OmitFeatures).@r_c396_SQLITE_OMIT_LOOKASIDE)) && (no (this.@r_c174_OmitFeatures).@r_c403_SQLITE_OMIT_MEMORYDB)) && (some (this.@r_c174_OmitFeatures).@r_c417_SQLITE_OMIT_PAGER_PRAGMAS)) && (no (this.@r_c174_OmitFeatures).@r_c424_SQLITE_OMIT_PRAGMA)) && (some (this.@r_c174_OmitFeatures).@r_c431_SQLITE_OMIT_PROGRESS_CALLBACK)) && (no (this.@r_c174_OmitFeatures).@r_c445_SQLITE_OMIT_REINDEX)) && (no (this.@r_c174_OmitFeatures).@r_c452_SQLITE_OMIT_SCHEMA_PRAGMAS)) && (no (this.@r_c174_OmitFeatures).@r_c459_SQLITE_OMIT_SCHEMA_VERSION_PRAGMAS)) && (some (this.@r_c174_OmitFeatures).@r_c473_SQLITE_OMIT_SUBQUERY)) && (no (this.@r_c174_OmitFeatures).@r_c480_SQLITE_OMIT_TCL_VARIABLE)) && (no (this.@r_c174_OmitFeatures).@r_c486_SQLITE_OMIT_TEMPDB)) && (some (this.@r_c174_OmitFeatures).@r_c499_SQLITE_OMIT_TRIGGER)) && (no (this.@r_c174_OmitFeatures).@r_c506_SQLITE_OMIT_TRUNCATE_OPTIMIZATION)) && (some (this.@r_c174_OmitFeatures).@r_c519_SQLITE_OMIT_VACUUM)) && (some (this.@r_c174_OmitFeatures).@r_c533_SQLITE_OMIT_VIRTUALTABLE)) && (no (this.@r_c174_OmitFeatures).@r_c540_SQLITE_OMIT_WAL)) && (no (this.@r_c174_OmitFeatures).@r_c547_SQLITE_OMIT_XFER_OPT)) && (some this.@r_c560_SQLITE_MEMDEBUG) }
