...
{}
{ (((((((((((((((((((((((((((((((((((((((((((((((((((((some this.@r_c4_OperatingSystemCharacteristics) && (some (this.@r_c4_OperatingSystemCharacteristics).@r_c10_SQLITE_4_BYTE_ALIGNED_MALLOC)) && (some (this.@r_c4_OperatingSystemCharacteristics).@r_c16_SQLITE_CASE_SENSITIVE_LIKE)) && (some (this.@r_c4_OperatingSystemCharacteristics).@r_c34_ChooseSQLITE_TEMP_STORE)) && (no ((this.@r_c4_OperatingSystemCharacteristics).@r_c34_ChooseSQLITE_TEMP_STORE).@r_c40_SQLITE_TEMP_STORE_EQ_0)) && (some ((this.@r_c4_OperatingSystemCharacteristics).@r_c34_ChooseSQLITE_TEMP_STORE).@r_c46_SQLITE_TEMP_STORE_EQ_1)) && (no ((this.@r_c4_OperatingSystemCharacteristics).@r_c34_ChooseSQLITE_TEMP_STORE).@r_c52_SQLITE_TEMP_STORE_EQ_2)) && (some (this.@r_c64_EnableFeatures).@r_c84_SQLITE_ENABLE_FTS3)) && (no (this.@r_c64_EnableFeatures).@r_c96_SQLITE_ENABLE_MEMORY_MANAGEMENT)) && (no (this.@r_c64_EnableFeatures).@r_c102_ChooseMemSys)) && (no ((this.@r_c64_EnableFeatures).@r_c102_ChooseMemSys).@r_c108_SQLITE_ENABLE_MEMSYS3)) && (no ((this.@r_c64_EnableFeatures).@r_c102_ChooseMemSys).@r_c114_SQLITE_ENABLE_MEMSYS5)) && (some (this.@r_c64_EnableFeatures).@r_c120_SQLITE_ENABLE_RTREE)) && (no (this.@r_c64_EnableFeatures).@r_c132_SQLITE_ENABLE_UPDATE_DELETE_LIMIT)) && (no (this.@r_c64_EnableFeatures).@r_c138_SQLITE_ENABLE_UNLOCK_NOTIFY)) && (some (this.@r_c64_EnableFeatures).@r_c144_SQLITE_SOUNDEX)) && (no (this.@r_c64_EnableFeatures).@r_c150_YYTRACKMAXSTACKDEPTH)) && (some this.@r_c156_DisableFeatures)) && (some this.@r_c174_OmitFeatures)) && (no (this.@r_c174_OmitFeatures).@r_c180_SQLITE_OMIT_ALTERTABLE)) && (some (this.@r_c174_OmitFeatures).@r_c187_SQLITE_OMIT_ANALYZE)) && (no (this.@r_c174_OmitFeatures).@r_c201_SQLITE_OMIT_AUTHORIZATION)) && (some (this.@r_c174_OmitFeatures).@r_c208_SQLITE_OMIT_AUTOINCREMENT)) && (no (this.@r_c174_OmitFeatures).@r_c215_SQLITE_OMIT_AUTOMATIC_INDEX)) && (some (this.@r_c174_OmitFeatures).@r_c235_SQLITE_OMIT_BETWEEN_OPTIMIZATION)) && (no (this.@r_c174_OmitFeatures).@r_c241_SQLITE_OMIT_BLOB_LITERAL)) && (some (this.@r_c174_OmitFeatures).@r_c255_SQLITE_OMIT_BUILTIN_TEST)) && (some (this.@r_c174_OmitFeatures).@r_c262_SQLITE_OMIT_CAST)) && (no (this.@r_c174_OmitFeatures).@r_c276_SQLITE_OMIT_COMPILEOPTION_DIAGS)) && (no (this.@r_c174_OmitFeatures).@r_c283_SQLITE_OMIT_COMPLETE)) && (no (this.@r_c174_OmitFeatures).@r_c290_SQLITE_OMIT_COMPOUND_SELECT)) && (some (this.@r_c174_OmitFeatures).@r_c297_SQLITE_OMIT_CONFLICT_CLAUSE)) && (some (this.@r_c174_OmitFeatures).@r_c319_SQLITE_OMIT_DEPRECATED)) && (no (this.@r_c174_OmitFeatures).@r_c326_SQLITE_OMIT_EXPLAIN)) && (some (this.@r_c174_OmitFeatures).@r_c333_SQLITE_OMIT_FLAG_PRAGMAS)) && (some (this.@r_c174_OmitFeatures).@r_c340_SQLITE_OMIT_FLOATING_POINT)) && (some (this.@r_c174_OmitFeatures).@r_c361_SQLITE_OMIT_INCRBLOB)) && (some (this.@r_c174_OmitFeatures).@r_c368_SQLITE_OMIT_INTEGRITY_CHECK)) && (some (this.@r_c174_OmitFeatures).@r_c382_SQLITE_OMIT_LOAD_EXTENSION)) && (some (this.@r_c174_OmitFeatures).@r_c389_SQLITE_OMIT_LOCALTIME)) && (no (this.@r_c174_OmitFeatures).@r_c396_SQLITE_OMIT_LOOKASIDE)) && (some (this.@r_c174_OmitFeatures).@r_c417_SQLITE_OMIT_PAGER_PRAGMAS)) && (no (this.@r_c174_OmitFeatures).@r_c431_SQLITE_OMIT_PROGRESS_CALLBACK)) && (no (this.@r_c174_OmitFeatures).@r_c445_SQLITE_OMIT_REINDEX)) && (some (this.@r_c174_OmitFeatures).@r_c452_SQLITE_OMIT_SCHEMA_PRAGMAS)) && (some (this.@r_c174_OmitFeatures).@r_c459_SQLITE_OMIT_SCHEMA_VERSION_PRAGMAS)) && (no (this.@r_c174_OmitFeatures).@r_c473_SQLITE_OMIT_SUBQUERY)) && (some (this.@r_c174_OmitFeatures).@r_c486_SQLITE_OMIT_TEMPDB)) && (some (this.@r_c174_OmitFeatures).@r_c499_SQLITE_OMIT_TRIGGER)) && (some (this.@r_c174_OmitFeatures).@r_c506_SQLITE_OMIT_TRUNCATE_OPTIMIZATION)) && (some (this.@r_c174_OmitFeatures).@r_c519_SQLITE_OMIT_VACUUM)) && (some (this.@r_c174_OmitFeatures).@r_c533_SQLITE_OMIT_VIRTUALTABLE)) && (some (this.@r_c174_OmitFeatures).@r_c540_SQLITE_OMIT_WAL)) && (some (this.@r_c174_OmitFeatures).@r_c547_SQLITE_OMIT_XFER_OPT) }
