...
{}
{ (((((((some (this.@r_c10_ContactListSource).@r_c16_ServerRoster) && (no this.@r_c22_XEP0085)) && (no (this.@r_c22_XEP0085).@r_c28_Composing)) && (no (this.@r_c22_XEP0085).@r_c34_SendComposing)) && (no this.@r_c40_History)) && (some this.@r_c52_XEP0092)) && (no (this.@r_c52_XEP0092).@r_c58_SendVersion)) && (some this.@r_c64_ThemeSelection) }
