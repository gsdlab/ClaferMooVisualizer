...
{}
{ ((((((((((((no (this.@r_c4_AbstractElement).@r_c11_ElementA) && (no (this.@r_c4_AbstractElement).@r_c17_ElementB)) && (some (this.@r_c4_AbstractElement).@r_c23_ElementC)) && (some this.@r_c29_AbstractIterator)) && (some (this.@r_c29_AbstractIterator).@r_c35_ForwardIterator)) && (no (this.@r_c47_AbstractSort).@r_c59_MergeSort)) && (no (this.@r_c47_AbstractSort).@r_c71_QuickSort)) && (no this.@r_c77_print)) && (some this.@r_c83_Measurement)) && (some (this.@r_c83_Measurement).@r_c91_TCP_IP)) && (some (this.@r_c83_Measurement).@r_c97_SyntheticPerformanceOrMemorySize)) && (some ((this.@r_c83_Measurement).@r_c97_SyntheticPerformanceOrMemorySize).@r_c103_Performance)) && (some this.@r_c115_Base) }
