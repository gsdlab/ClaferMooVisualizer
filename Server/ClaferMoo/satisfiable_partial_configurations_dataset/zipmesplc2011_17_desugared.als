...
{}
{ ((((some (this.@r_c4_base).@r_c16_zipMecompress) && (some this.@r_c28_zipMearchiveCheck)) && (no this.@r_c34_zipMeGZIP)) && (no this.@r_c46_zipMeadler32Chcksum)) && (no this.@r_c52_zipMeextract) }
