...
{}
{ (((no (this.@r_c22_XEP0085).@r_c28_Composing) && (no (this.@r_c22_XEP0085).@r_c34_SendComposing)) && (some (this.@r_c52_XEP0092).@r_c58_SendVersion)) && (some this.@r_c64_ThemeSelection) }
