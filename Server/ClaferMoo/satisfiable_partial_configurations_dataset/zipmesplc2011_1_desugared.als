...
{}
{ ((((some this.@r_c22_zipMeCRC) && (no this.@r_c28_zipMearchiveCheck)) && (some this.@r_c40_zipMeadaptation)) && (no this.@r_c46_zipMeadler32Chcksum)) && (some this.@r_c52_zipMeextract) }
