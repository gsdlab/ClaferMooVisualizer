...
{}
{ ((((((some this.@r_c4_base) && (some (this.@r_c4_base).@r_c16_zipMecompress)) && (no this.@r_c28_zipMearchiveCheck)) && (no this.@r_c34_zipMeGZIP)) && (some this.@r_c40_zipMeadaptation)) && (no this.@r_c46_zipMeadler32Chcksum)) && (no this.@r_c52_zipMeextract) }
