...
{}
{ (((((((some this.@r_c4_AbstractElement) && (no (this.@r_c4_AbstractElement).@r_c11_ElementA)) && (no (this.@r_c4_AbstractElement).@r_c17_ElementB)) && (no (this.@r_c29_AbstractIterator).@r_c35_ForwardIterator)) && (some this.@r_c47_AbstractSort)) && (no (this.@r_c47_AbstractSort).@r_c59_MergeSort)) && (some (this.@r_c47_AbstractSort).@r_c65_InsertionSort)) && (no (this.@r_c83_Measurement).@r_c97_SyntheticPerformanceOrMemorySize) }
