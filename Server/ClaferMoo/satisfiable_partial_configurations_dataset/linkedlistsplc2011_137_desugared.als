...
{}
{ ((((((((((some this.@r_c4_AbstractElement) && (some (this.@r_c29_AbstractIterator).@r_c35_ForwardIterator)) && (no (this.@r_c29_AbstractIterator).@r_c41_BackwardIterator)) && (no this.@r_c47_AbstractSort)) && (no (this.@r_c47_AbstractSort).@r_c53_BubbleSort)) && (no (this.@r_c47_AbstractSort).@r_c59_MergeSort)) && (no (this.@r_c47_AbstractSort).@r_c71_QuickSort)) && (some this.@r_c77_print)) && (no ((this.@r_c83_Measurement).@r_c97_SyntheticPerformanceOrMemorySize).@r_c103_Performance)) && (no ((this.@r_c83_Measurement).@r_c97_SyntheticPerformanceOrMemorySize).@r_c109_MemorySize)) && (some this.@r_c115_Base) }
