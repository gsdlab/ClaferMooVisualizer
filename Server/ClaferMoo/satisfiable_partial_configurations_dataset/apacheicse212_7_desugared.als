...
{}
{ ((((((no this.@r_c10_HostnameLookups) && (some this.@r_c17_KeepAlive)) && (no this.@r_c23_EnableSendfile)) && (some this.@r_c35_AccessLog)) && (some this.@r_c42_ExtendedStatus)) && (some this.@r_c49_InMemory)) && (no this.@r_c57_Handle) }
