...
{}
{ (((((((((((((((((((((((((((((((((((((((((((((((((((((some this.@r_c4_OperatingSystemCharacteristics) && (some (this.@r_c4_OperatingSystemCharacteristics).@r_c10_SQLITE_4_BYTE_ALIGNED_MALLOC)) && (no (this.@r_c4_OperatingSystemCharacteristics).@r_c22_SQLITE_HAVE_ISNAN)) && (no (this.@r_c4_OperatingSystemCharacteristics).@r_c28_SQLITE_SECURE_DELETE)) && (no ((this.@r_c4_OperatingSystemCharacteristics).@r_c34_ChooseSQLITE_TEMP_STORE).@r_c46_SQLITE_TEMP_STORE_EQ_1)) && (some ((this.@r_c4_OperatingSystemCharacteristics).@r_c34_ChooseSQLITE_TEMP_STORE).@r_c52_SQLITE_TEMP_STORE_EQ_2)) && (some this.@r_c64_EnableFeatures)) && (no (this.@r_c64_EnableFeatures).@r_c70_SQLITE_ENABLE_ATOMIC_WRITE)) && (no (this.@r_c64_EnableFeatures).@r_c76_SQLITE_ENABLE_COLUMN_METADATA)) && (some (this.@r_c64_EnableFeatures).@r_c84_SQLITE_ENABLE_FTS3)) && (some (this.@r_c64_EnableFeatures).@r_c96_SQLITE_ENABLE_MEMORY_MANAGEMENT)) && (some ((this.@r_c64_EnableFeatures).@r_c102_ChooseMemSys).@r_c108_SQLITE_ENABLE_MEMSYS3)) && (some (this.@r_c64_EnableFeatures).@r_c126_SQLITE_ENABLE_STAT2)) && (some (this.@r_c64_EnableFeatures).@r_c138_SQLITE_ENABLE_UNLOCK_NOTIFY)) && (some (this.@r_c64_EnableFeatures).@r_c144_SQLITE_SOUNDEX)) && (some this.@r_c156_DisableFeatures)) && (no (this.@r_c156_DisableFeatures).@r_c162_SQLITE_DISABLE_LFS)) && (no (this.@r_c156_DisableFeatures).@r_c168_SQLITE_DISABLE_DIRSYNC)) && (some (this.@r_c174_OmitFeatures).@r_c180_SQLITE_OMIT_ALTERTABLE)) && (no (this.@r_c174_OmitFeatures).@r_c194_SQLITE_OMIT_ATTACH)) && (some (this.@r_c174_OmitFeatures).@r_c201_SQLITE_OMIT_AUTHORIZATION)) && (no (this.@r_c174_OmitFeatures).@r_c208_SQLITE_OMIT_AUTOINCREMENT)) && (no (this.@r_c174_OmitFeatures).@r_c215_SQLITE_OMIT_AUTOMATIC_INDEX)) && (some (this.@r_c174_OmitFeatures).@r_c222_SQLITE_OMIT_AUTOINIT)) && (no (this.@r_c174_OmitFeatures).@r_c228_SQLITE_OMIT_AUTOVACUUM)) && (some (this.@r_c174_OmitFeatures).@r_c235_SQLITE_OMIT_BETWEEN_OPTIMIZATION)) && (some (this.@r_c174_OmitFeatures).@r_c255_SQLITE_OMIT_BUILTIN_TEST)) && (some (this.@r_c174_OmitFeatures).@r_c262_SQLITE_OMIT_CAST)) && (some (this.@r_c174_OmitFeatures).@r_c269_SQLITE_OMIT_CHECK)) && (some (this.@r_c174_OmitFeatures).@r_c276_SQLITE_OMIT_COMPILEOPTION_DIAGS)) && (no (this.@r_c174_OmitFeatures).@r_c283_SQLITE_OMIT_COMPLETE)) && (no (this.@r_c174_OmitFeatures).@r_c290_SQLITE_OMIT_COMPOUND_SELECT)) && (some (this.@r_c174_OmitFeatures).@r_c303_SQLITE_OMIT_DATETIME_FUNCS)) && (no (this.@r_c174_OmitFeatures).@r_c310_SQLITE_OMIT_DECLTYPE)) && (some (this.@r_c174_OmitFeatures).@r_c319_SQLITE_OMIT_DEPRECATED)) && (no (this.@r_c174_OmitFeatures).@r_c333_SQLITE_OMIT_FLAG_PRAGMAS)) && (some (this.@r_c174_OmitFeatures).@r_c354_SQLITE_OMIT_GET_TABLE)) && (no (this.@r_c174_OmitFeatures).@r_c375_SQLITE_OMIT_LIKE_OPTIMIZATION)) && (no (this.@r_c174_OmitFeatures).@r_c382_SQLITE_OMIT_LOAD_EXTENSION)) && (no (this.@r_c174_OmitFeatures).@r_c389_SQLITE_OMIT_LOCALTIME)) && (no (this.@r_c174_OmitFeatures).@r_c396_SQLITE_OMIT_LOOKASIDE)) && (no (this.@r_c174_OmitFeatures).@r_c403_SQLITE_OMIT_MEMORYDB)) && (some (this.@r_c174_OmitFeatures).@r_c424_SQLITE_OMIT_PRAGMA)) && (some (this.@r_c174_OmitFeatures).@r_c438_SQLITE_OMIT_QUICKBALANCE)) && (no (this.@r_c174_OmitFeatures).@r_c445_SQLITE_OMIT_REINDEX)) && (some (this.@r_c174_OmitFeatures).@r_c459_SQLITE_OMIT_SCHEMA_VERSION_PRAGMAS)) && (no (this.@r_c174_OmitFeatures).@r_c466_SQLITE_OMIT_SHARED_CACHE)) && (no (this.@r_c174_OmitFeatures).@r_c473_SQLITE_OMIT_SUBQUERY)) && (some (this.@r_c174_OmitFeatures).@r_c480_SQLITE_OMIT_TCL_VARIABLE)) && (some (this.@r_c174_OmitFeatures).@r_c486_SQLITE_OMIT_TEMPDB)) && (no (this.@r_c174_OmitFeatures).@r_c499_SQLITE_OMIT_TRIGGER)) && (no (this.@r_c174_OmitFeatures).@r_c519_SQLITE_OMIT_VACUUM)) && (some this.@r_c554_SQLITE_DEBUG)) && (no this.@r_c560_SQLITE_MEMDEBUG) }
