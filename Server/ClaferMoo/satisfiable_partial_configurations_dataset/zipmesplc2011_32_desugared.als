...
{}
{ (((((((some this.@r_c4_base) && (some (this.@r_c4_base).@r_c10_zipMe)) && (some (this.@r_c4_base).@r_c16_zipMecompress)) && (no this.@r_c22_zipMeCRC)) && (no this.@r_c34_zipMeGZIP)) && (no this.@r_c40_zipMeadaptation)) && (some this.@r_c46_zipMeadler32Chcksum)) && (no this.@r_c52_zipMeextract) }
