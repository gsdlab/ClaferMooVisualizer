...
{}
{ (((((((some this.@r_c4_Base) && (some (this.@r_c10_ContactListSource).@r_c16_ServerRoster)) && (some this.@r_c22_XEP0085)) && (some (this.@r_c22_XEP0085).@r_c28_Composing)) && (some this.@r_c40_History)) && (some this.@r_c46_Timestamps)) && (no (this.@r_c52_XEP0092).@r_c58_SendVersion)) && (some this.@r_c64_ThemeSelection) }
