...
{ (this.@r_c114_total_performance.@c114_total_performance_ref) = (((((((this.@r_c8_Connectivity).@r_c2_performance.@c2_performance_ref).add[(((this.@r_c8_Connectivity).@r_c24_Bluetooth).@r_c2_performance.@c2_performance_ref)]).add[(((this.@r_c8_Connectivity).@r_c40_USB).@r_c2_performance.@c2_performance_ref)]).add[(((this.@r_c8_Connectivity).@r_c56_Wifi).@r_c2_performance.@c2_performance_ref)]).add[((this.@r_c72_PasswordProtection).@r_c2_performance.@c2_performance_ref)]).add[((this.@r_c93_FingerprintProtection).@r_c2_performance.@c2_performance_ref)])
  ...
  (this.@r_c176_total_mass.@c176_total_mass_ref) = (((((((this.@r_c8_Connectivity).@r_c4_mass.@c4_mass_ref).add[(((this.@r_c8_Connectivity).@r_c24_Bluetooth).@r_c4_mass.@c4_mass_ref)]).add[(((this.@r_c8_Connectivity).@r_c40_USB).@r_c4_mass.@c4_mass_ref)]).add[(((this.@r_c8_Connectivity).@r_c56_Wifi).@r_c4_mass.@c4_mass_ref)]).add[((this.@r_c72_PasswordProtection).@r_c4_mass.@c4_mass_ref)]).add[((this.@r_c93_FingerprintProtection).@r_c4_mass.@c4_mass_ref)]) }
...
one sig c202_MyPhone extends c7_MobilePhone
{}

objectives o_global {
minimize c202_MyPhone.@r_c140_total_energy.@c140_total_energy_ref ,
maximize c202_MyPhone.@r_c114_total_performance.@c114_total_performance_ref ,
maximize c202_MyPhone.@r_c166_total_security.@c166_total_security_ref ,
minimize c202_MyPhone.@r_c176_total_mass.@c176_total_mass_ref 
}sig bag_extra_ints{
  extra_ints : set Int
}
inst partial_speedup {
   ...
   , c93_FingerprintProtection in partial_c93_FingerprintProtection
    ,  c2_performance in performance_for_c8_Connectivity_of_0 + performance_for_c24_Bluetooth_of_9 + performance_for_c40_USB_of_10 + performance_for_c56_Wifi_of_22 + performance_for_c72_PasswordProtection_of_1 + performance_for_c93_FingerprintProtection_of_2
    ,  c3_energy in energy_for_c8_Connectivity_of_0 + energy_for_c24_Bluetooth_of_10 + energy_for_c40_USB_of_5 + energy_for_c56_Wifi_of_17 + energy_for_c72_PasswordProtection_of_2 + energy_for_c93_FingerprintProtection_of_4
    ,  c4_mass in mass_for_c8_Connectivity_of_0 + mass_for_c24_Bluetooth_of_2 + mass_for_c40_USB_of_3 + mass_for_c56_Wifi_of_6 + mass_for_c72_PasswordProtection_of_0 + mass_for_c93_FingerprintProtection_of_0
    ,  c6_security in security_for_c72_PasswordProtection_of_5 + security_for_c93_FingerprintProtection_of_5
    , r_c2_performance in partial_c8_Connectivity->performance_for_c8_Connectivity_of_0 + partial_c24_Bluetooth->performance_for_c24_Bluetooth_of_9 + partial_c40_USB->performance_for_c40_USB_of_10 + partial_c56_Wifi->performance_for_c56_Wifi_of_22 + partial_c72_PasswordProtection->performance_for_c72_PasswordProtection_of_1 + partial_c93_FingerprintProtection->performance_for_c93_FingerprintProtection_of_2
    , r_c3_energy in partial_c8_Connectivity->energy_for_c8_Connectivity_of_0 + partial_c24_Bluetooth->energy_for_c24_Bluetooth_of_10 + partial_c40_USB->energy_for_c40_USB_of_5 + partial_c56_Wifi->energy_for_c56_Wifi_of_17 + partial_c72_PasswordProtection->energy_for_c72_PasswordProtection_of_2 + partial_c93_FingerprintProtection->energy_for_c93_FingerprintProtection_of_4
    , r_c4_mass in partial_c8_Connectivity->mass_for_c8_Connectivity_of_0 + partial_c24_Bluetooth->mass_for_c24_Bluetooth_of_2 + partial_c40_USB->mass_for_c40_USB_of_3 + partial_c56_Wifi->mass_for_c56_Wifi_of_6 + partial_c72_PasswordProtection->mass_for_c72_PasswordProtection_of_0 + partial_c93_FingerprintProtection->mass_for_c93_FingerprintProtection_of_0
    ...
    , c2_performance_ref in performance_for_c8_Connectivity_of_0-> 0 + performance_for_c24_Bluetooth_of_9-> 9 + performance_for_c40_USB_of_10-> 10 + performance_for_c56_Wifi_of_22-> 22 + performance_for_c72_PasswordProtection_of_1-> 1 + performance_for_c93_FingerprintProtection_of_2-> 2
    , c3_energy_ref in energy_for_c8_Connectivity_of_0-> 0 + energy_for_c24_Bluetooth_of_10-> 10 + energy_for_c40_USB_of_5-> 5 + energy_for_c56_Wifi_of_17-> 17 + energy_for_c72_PasswordProtection_of_2-> 2 + energy_for_c93_FingerprintProtection_of_4-> 4
    , c4_mass_ref in mass_for_c8_Connectivity_of_0-> 0 + mass_for_c24_Bluetooth_of_2-> 2 + mass_for_c40_USB_of_3-> 3 + mass_for_c56_Wifi_of_6-> 6 + mass_for_c72_PasswordProtection_of_0-> 0 + mass_for_c93_FingerprintProtection_of_0-> 0
